...
case $interrupt_selection in
	"0")
		...
		ret=`sudo insmod /usr/lib/modules/6.8.0-49-generic/xdma/xdma.ko interrupt_mode=0`
		;;
	"1")
		echo "insmod xdma.ko interrupt_mode=2 ..."
		ret=`sudo insmod /usr/lib/modules/6.8.0-49-generic/xdma/xdma.ko interrupt_mode=1`
		;;
	"2")
		echo "insmod xdma.ko interrupt_mode=3 ..."
		ret=`sudo insmod ./usr/lib/modules/6.8.0-49-generic/xdma/xdma.ko interrupt_mode=2`
		;;
	"3")
		echo "insmod xdma.ko interrupt_mode=4 ..."
		ret=`sudo insmod /usr/lib/modules/6.8.0-49-generic/xdma/xdma.ko interrupt_mode=3`
		;;
	"4")
		echo "insmod xdma.ko poll_mode=1 ..."
		ret=`sudo insmod /usr/lib/modules/6.8.0-49-generic/xdma/xdma.ko poll_mode=1`
		;;
	*)
